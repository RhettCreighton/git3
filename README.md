...
**Project Home: https://github.com/RhettCreighton/git3**  
**License: GPL v2**

**⚠️ CRITICAL: Git3 ONLY supports SHA3-256. There is NO support for SHA-1 or SHA-256.**

Git3 is a hard fork of Git that has been modified to use **SHA3-256 as the ONLY supported hash algorithm**. All support for SHA-1 and SHA-256 has been completely removed from the codebase. This makes Git3 completely incompatible with standard Git repositories.

## ⚠️ SHA3-ONLY WARNING ⚠️

**This is NOT regular Git!** Git3:
- ✅ **ONLY** supports SHA3-256 hashing
- ❌ Does **NOT** support SHA-1 (removed)
- ❌ Does **NOT** support SHA-256 (removed)
- ❌ Cannot read regular Git repositories
- ❌ Cannot push/pull to/from regular Git repositories
- ❌ Cannot be used with GitHub, GitLab, or any standard Git hosting
- ❌ Cannot convert existing repositories to SHA3

**If you need SHA-1 or SHA-256 support, use regular Git, not Git3!**
...
- SHA3 implementation: Copyright (C) 2025 Rhett Creighton
